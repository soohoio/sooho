...
yq -i '."servers"+=[{"url":"https://stayking.xyz","description":"StayKing mainnet node"},{"url":"https://testnet.stayking.xyz","description":"StayKing testnet node"}]' static/openapi/openapi.yaml
