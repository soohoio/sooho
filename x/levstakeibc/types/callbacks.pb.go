...
func (*Rebalancing) Descriptor() ([]byte, []int) {
	return fileDescriptor_aba33a0433787ff2, []int{7}
}
...
func (*RebalanceCallback) Descriptor() ([]byte, []int) {
	return fileDescriptor_aba33a0433787ff2, []int{8}
}
...
func init() {
	...
	proto.RegisterType((*Rebalancing)(nil), "stayking.levstakeibc.Rebalancing")
	proto.RegisterType((*RebalanceCallback)(nil), "stayking.levstakeibc.RebalanceCallback")
}
...
var fileDescriptor_aba33a0433787ff2 = []byte{
	...
	,
}
