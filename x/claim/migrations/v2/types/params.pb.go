...
func init() {
	proto.RegisterType((*Params)(nil), "stayking.claim.V2Params")
	proto.RegisterType((*Airdrop)(nil), "stayking.claim.V2Airdrop")
}

func init() { proto.RegisterFile("stayking/claim/params.proto", fileDescriptor_dd7ac871d3875dc3) }
