...
func init() {
	proto.RegisterEnum("stayking.stakeibc.V2ICAAccountType", ICAAccountType_name, ICAAccountType_value)
	proto.RegisterType((*ICAAccount)(nil), "stayking.stakeibc.V2ICAAccount")
}
