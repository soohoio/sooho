...
func init() {
	proto.RegisterEnum("stayking.stakeibc.V2Validator_ValidatorStatus", Validator_ValidatorStatus_name, Validator_ValidatorStatus_value)
	proto.RegisterType((*ValidatorExchangeRate)(nil), "stayking.stakeibc.V2ValidatorExchangeRate")
	proto.RegisterType((*Validator)(nil), "stayking.stakeibc.V2Validator")
}
