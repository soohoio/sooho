...
var (
	pattern_Query_Pool_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"stayking", "lendingpool", "v1", "pool"}, "", runtime.AssumeColonVerbOpt(false)))
)
