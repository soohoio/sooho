...
type Upgrade struct {
	...
	CreateUpgradeHandler func(*module.Manager, module.Configurator, BaseAppParamManager, *app.StayKingApp) upgradetypes.UpgradeHandler
...
type Fork struct {
	...
	BeginForkLogic func(ctx sdk.Context, keepers *app.StayKingApp)
}
