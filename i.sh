...
gaiad tx ibc-transfer transfer transfer channel-0 sooho1pw0c95syjpn592ara0jp3shavaxdlhnnll2vs8 1000000000uatom --from gval1 --keyring-backend test --chain-id GAIA --fees 1000uatom --gas auto --node http://gaia1:26657 -y
#gaiad tx ibc-transfer transfer transfer channel-0 sooho143umg272xger2eyurqfpjgt8u533s62mpz5weq 1000000000uatom --from gval1 --keyring-backend test --chain-id GAIA --fees 1000uatom --gas auto --node http://gaia1:26657 -y
#gaiad tx ibc-transfer transfer transfer channel-0 sooho10v2nzm6wgasg28qvukh8dp5vfqfhwyaksuefdx 1000000000uatom --from gval1 --keyring-backend test --chain-id GAIA --fees 1000uatom --gas auto --node http://gaia1:26657 -y
