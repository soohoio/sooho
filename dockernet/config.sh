...
IBC_EVMOS_DENOM=$IBC_EVMOS_CHANNEL_1_DENOM
IBC_OSMOSIS_DENOM=$IBC_OSMOSIS_CHANNEL_2_DENOM
# CHAIN PARAMS
BLOCK_TIME='5s'
STAYKING_DAY_EPOCH_DURATION="140s"
STAYKING_EPOCH_EPOCH_DURATION="80s"
HOST_DAY_EPOCH_DURATION="60s"
HOST_HOUR_EPOCH_DURATION="60s"
HOST_WEEK_EPOCH_DURATION="60s"
STAYKING_UNBONDING_TIME="240s"
...
EVMOS_VAL_TOKENS=500000000000000000000000
STAKE_TOKENS=5000000000
ADMIN_TOKENS=1000000000
EVMOS_ADMIN_TOKENS=100000000000000000000000
...
HOST_RELAYER_ACCTS=($RELAYER_GAIA_ACCT $RELAYER_EVMOS_ACCT $RELAYER_OSMOSIS_ACCT)
RELAYER_MNEMONICS=("$RELAYER_GAIA_MNEMONIC" "$RELAYER_EVMOS_MNEMONIC" "$RELAYER_OSMOSIS_MNEMONIC")
...
GET_ICA_ADDR() {
  ...
  $STAYKING_MAIN_CMD q levstakeibc show-host-zone $chain_id | grep ${ica_type}_account -A 1 | grep address | awk '{print $2}'
}
