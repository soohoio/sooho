...
import { Module as StaykingClaim, msgTypes as StaykingClaimMsgTypes } from './stayking.claim'
import { Module as StaykingEpochs, msgTypes as StaykingEpochsMsgTypes } from './stayking.epochs'
import { Module as StaykingIcacallbacks, msgTypes as StaykingIcacallbacksMsgTypes } from './stayking.icacallbacks'
import { Module as StaykingInterchainqueryV1, msgTypes as StaykingInterchainqueryV1MsgTypes } from './stayking.interchainquery.v1'
import { Module as StaykingMintV1Beta1, msgTypes as StaykingMintV1Beta1MsgTypes } from './stayking.mint.v1beta1'
import { Module as StaykingRecords, msgTypes as StaykingRecordsMsgTypes } from './stayking.records'
import { Module as StaykingStakeibc, msgTypes as StaykingStakeibcMsgTypes } from './stayking.stakeibc'
import { Module as StaykingVesting, msgTypes as StaykingVestingMsgTypes } from './stayking.vesting'


const Client = IgniteClient.plugin([
    CosmosAuthV1Beta1, CosmosAuthzV1Beta1, CosmosBankV1Beta1, CosmosBaseTendermintV1Beta1, CosmosCrisisV1Beta1, CosmosDistributionV1Beta1, CosmosEvidenceV1Beta1, CosmosFeegrantV1Beta1, CosmosParamsV1Beta1, CosmosSlashingV1Beta1, CosmosStakingV1Beta1, CosmosTxV1Beta1, CosmosUpgradeV1Beta1, CosmosVestingV1Beta1, IbcApplicationsInterchainAccountsControllerV1, IbcApplicationsInterchainAccountsHostV1, IbcApplicationsTransferV1, IbcCoreChannelV1, IbcCoreClientV1, IbcCoreConnectionV1, StaykingClaim, StaykingEpochs, StaykingIcacallbacks, StaykingInterchainqueryV1, StaykingMintV1Beta1, StaykingRecords, StaykingStakeibc, StaykingVesting
]);
...
const registry = new Registry([
  ...
  ...StaykingClaimMsgTypes,
  ...StaykingEpochsMsgTypes,
  ...StaykingIcacallbacksMsgTypes,
  ...StaykingInterchainqueryV1MsgTypes,
  ...StaykingMintV1Beta1MsgTypes,
  ...StaykingRecordsMsgTypes,
  ...StaykingStakeibcMsgTypes,
  ...StaykingVestingMsgTypes,
