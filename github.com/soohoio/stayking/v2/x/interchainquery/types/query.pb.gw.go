...
var (
	pattern_QueryService_PendingQueries_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"stayking", "interchainquery", "pending_queries"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_QueryService_QueryState_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"stayking", "interchainquery", "query_state"}, "", runtime.AssumeColonVerbOpt(false)))
)
